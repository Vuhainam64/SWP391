    ...
    <motion.div className="w-full grid grid-cols-1 md:grid-cols-2 gap-4 ">
      <div className="flex flex-col items-start justify-start gap-6">
        ...
        <p className="text-textColor text-lg">
          If you're looking for a website to buy bird food, you've come to the
          right place! Our online store offers a wide variety of bird feed and
          treats to meet the dietary needs of your feathered friends. From
          premium seed blends to tasty mealworms, we have everything you need to
          keep your birds happy and healthy. Our products are sourced from
          trusted brands and are of the highest quality. Plus, with our
          easy-to-navigate website and secure checkout process, buying bird food
          has never been easier. So whether you have pet parrots or wild finches
          in your backyard, shop with us for all your bird feeding needs.
        </p>
        <motion.button
          {...buttonClick}
