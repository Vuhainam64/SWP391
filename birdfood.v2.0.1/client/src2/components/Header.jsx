  ...
  return (
    <header className="fixed backdrop-blur-md z-50 inset-x-0 top-0 flex items-center justify-between px-12 md:px-20 py-6">
      <NavLink to={"/"} className="flex items-center justify-center gap-4">
        ...
        <p className="font-semibold text-xl">Bird Food</p>
      </NavLink>
      <nav className="flex items-center justify-center gap-8">
        ...
        {user ? (
          <>
            ...
            >
              <div
                className="w-12 h-12 rounded-full shadow-md cursor-pointer overflow-hidden flex
              ...
              {isMenu && (
                <motion.div
                  ...
                  className="px-6 py-4 w-48 bg-lightOverlay backdrop-blur-md rounded-md shadow-md
                        absolute top-12 right-0 flex flex-col gap-4"
                >
                  <Link
          ...
          <>
            <NavLink to={"/login"}>
              <motion.button
                ...
                border border-orange-300 cursor-pointer"
              >
                Login
              </motion.button>
            </NavLink>
