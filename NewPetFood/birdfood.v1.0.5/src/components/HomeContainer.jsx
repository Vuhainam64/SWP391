...
function HomeContainer() {
    ...
    >
        ...
        justify-center gap-6">
            ...
            <p className="text-[2.5rem] lg:text-[4.5] font-bold tracking-wide text-headingColor">
            The Fastest Delivery in {''}
            <span className="text-orange-600 text-[3rem] md:text-[5rem]">Your City</span>
            </p>

            <p className="text-base text-textColor text-center md:text-left md:w-[80%]">
            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Cum numquam quisquam,
            neque fugit tenetur reiciendis tempora assumenda delectus placeat error 
            aspernatur, deserunt rem pariatur aliquid fuga sunt distinctio eius obcaecati?
            </p>
        ...
        <div className="py-2 flex-1 flex items-center relative">
            ...
            lg:px-32 py-4 gap-4 flex-wrap">
                {heroData && heroData.map(n =>(
                    ...
                    rounded-2xl flex flex-col items-center justify-center drop-shadow-lg">
                        <img 
                        src={n.imageSrc}
