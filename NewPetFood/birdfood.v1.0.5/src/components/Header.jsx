...
function Header() {
    ...
    const [{user, cartShow, cartItems}, dispath] = useStateValue()
        ...
        md:px-16 bg-primary">
            ...
            <div className="hidden md:flex w-full h-full items-center justify-between">
                <Link to={'/'} className="flex items-center gap-2">
                    ...
                    <p className="text-headingColor text-xl font-bold">BirdFood</p>
                </Link>
                ...
                <div className="flex items-center gap-8">
                    ...
                    className="flex items-center gap-8">
                        ...
                        duration-100 transition-all ease-out cursor-pointer">
                            Home
                        </li>
                        <li className="text-base text-textColor hover:text-headingColor
                        duration-100 transition-all ease-out cursor-pointer">
                    ...
                    >
                        ...
                        {cartItems && cartItems.length > 0 && (
                            ...
                            flex items-center justify-center">
                                <p className="text-sx text-white font-semibold">{cartItems.length}</p>
                            </div>
                        )}
                    </div>
                    ...
                    <div className="relative">
                        ...
                        />
                        {
                            isMenu && (
                                ...
                                {
                                    user && user.email === "vuhainam272@gmail.com" && (
                                        <Link to='/createItem'>
                        ...
                        />
                        {
                            isMenu && (
                                ...
                                className="flex flex-col">
                                    <li className="text-base text-textColor hover:text-headingColor
                                    duration-100 transition-all ease-out cursor-pointer hover:bg-slate-100 px-4 py-2"
                                ...
                                <p className="m-2 p-2 rounded-md shadow-md flex items-center justify-center bg-slate-200 gap-3 cursor-pointer
