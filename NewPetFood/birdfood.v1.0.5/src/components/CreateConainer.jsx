...
import { MdFastfood, MdUpload, MdDelete, MdFoodBank, MdAttachMoney } from 'react-icons/md'
  ...
  const saveDetails = () => {
    ...
    try {
      if(!title || !calories || !imageAsset || !price || !category){
        setFields(true)
        setMsg("Required fields can't be emty 😅")
        setAlertStatus('danger')
        setTimeout(() => {
          setFields(false)
          setIsLoading(false)
    ...
    <div className="w-full min-h-screen flex items-center justify-center">
      ...
      >
        ...
        items-center gap-2">
          ...
          className="w-full ffull  text-lg bg-transparent font-semibold
        ...
        <div className="w-full">
          ...
          p-2 rounded-md cursor-pointer">
            ...
            {categories && categories.map(item => (
              <option 
              key={item.id} 
              className="text-base border-spacing-0 outline-none capitalize
          ...
          {isLoading ? <Loader/> : <>
              {!imageAsset ? <>
                ...
                items-center justify-center gap-2">
                    <MdUpload className="text-gray-500 text-3xl
                    hover:text-gray-700"/>
              ...
              <div className="relative h-full">
                ...
                <button 
                type="button"
                className="absolute bottom-3 right-3 p-3 bg-red-500
                text-xl cursor-pointer outline-none hover:shadow-md
                duration-500 transition-all ease-in-out rounded-full"
                onClick={deleteImage}
